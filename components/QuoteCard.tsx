  ...
  if (loading && !quote) {
    return (
      <div className="animate-pulse rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        ...
        <div className="mt-4 h-10 w-32 rounded bg-gray-200 dark:bg-gray-800" />
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
      ...
      <dl className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-4">
        <div>
          <dt className="text-xs text-gray-400">開盤</dt>
        ...
        <div>
          <dt className="text-xs text-gray-400">昨收</dt>
          <dd className="text-sm font-medium text-gray-800 dark:text-gray-200">
            {formatNumber(quote.prevClose)}
          </dd>
        </div>
        <div>
          <dt className="text-xs text-gray-400">成交量（張）</dt>
          <dd className="text-sm font-medium text-gray-800 dark:text-gray-200">
